...
<!-- END MENU SIDEBAR -->
        ...
        <div class="main-content">
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <!-- Button to trigger-->
                    <a href="datajabatan-form.php" class="btn btn-primary mb-3">
                    Tambahkan Jabatan
                    </a>
                            ...
                            <table class="table table-borderless table-striped table-earning">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <a href="jabatan/hapus_jabatan.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a></td>
                                    </tr>
                                    <?php 
                                    $no++;
                                    }
