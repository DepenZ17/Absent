        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                    <!-- Button to trigger-->
                    <a href="datauser-form.php" class="btn btn-primary mb-3">
                    Tambahkan Admin
                    </a>
                        <div class="row">
                                ...
                                <table class="table table-borderless table-striped table-earning">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="admin/admin_edit.php?id=<?php echo $row['id']; ?>"><button class="btn btn-primary">Edit</button></a>
                                                <a href="admin/admin_hapus.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('Yakin ingin dihapus?');">Hapus</button></a>
                                            </td>
                                        </tr>
                                        <?php 
                                            $no++;
