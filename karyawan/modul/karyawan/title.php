                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-tachometer-alt"></i>Absen</a>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            <a class="js-arrow" href="?m=karyawan&s=absensi">
                                <i class="fa fa-calendar"></i>Data Absen</a>
                        </li>
                    </ul>
                </nav>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h3 class="title-1" style="text-align: center;">Silahkan masukkan keterangan anda, <?php echo $_SESSION['namasi']; ?></h3>
                            ...
                            <form action="modul/karyawan/keterangan_sv.php" method="post" enctype="multipart/form-data">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <td>Waktu</td>
                                            <td>
                                            <input readonly type="text" class="form-control" value="<?php echo date('l, d-m-Y h:i:s a'); ?>" name="waktu_display">
