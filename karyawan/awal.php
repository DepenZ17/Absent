                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <input class="au-input au-input--xl" type="text" name="search" value="Kehadiran" readonly="" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h3 class="title-1" style="text-align: center;">Selamat Datang <?php echo $_SESSION['namasi']; ?>, Silahkan Mengisi Daftar Hadir</h3>
                            ...
                            <form action="dt_absen_sv.php" method="post">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <td>Waktu</td>
                                            <td>
                                            <input type="text" class="form-control" value="<?php echo date('l, d-m-Y / h:i:s A'); ?>" name="waktu_display" readonly="">
                                            <input type="hidden" name="waktu" value="<?php echo date('d-m-Y H:i:s'); ?>">
                                            </td>
                                            </tr>
                                            ...
                                            <td></td>
                                            <td>
                                                <button type="submit" name="simpan" value="masuk" class="btn btn-primary">Masuk</button>
                                                <button type="submit" name="simpan" value="pulang" class="btn btn-danger">Pulang</button>
                                            </td>
                                            </tr>
