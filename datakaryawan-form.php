                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="table-responsive table--no-card m-b-30">
                            <form action="datakaryawan/dt_karyawan_sv.php" enctype="multipart/form-data" method="post">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="reset" class="btn btn-danger" onclick="window.location.href='datakaryawan.php';">Batal</button>
                                                </td>
                                            </tr>
