            ...
            <table class="table table-borderless table-striped table-earning">
                <thead>
                    <tr>
                        ...
                        <th class="text-right">Tanggal &Waktu</th>
                        <th>Bukti</th>
                        <th>Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    $data_karyawan = mysqli_query($koneksi, "SELECT * FROM tb_absen LIMIT $halaman_awal, $batas");
                    $no = $halaman_awal + 1;
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php 
                                if ($row['bukti'] != '') {
                                    echo "<img src=\"karyawan/modul/karyawan/buktiket/$row[bukti]\" />";
                                } else {
                            ...
                            <td>
                                <a href="absen/hapus_keterangan.php?id=<?php echo $row['id_absensi']; ?>">
